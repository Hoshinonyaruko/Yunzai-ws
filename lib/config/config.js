...
class Cfg {
  ...
  get bot () {
    ...
    bot.ws_reverse_url = this.getConfig('qq').ws_reverse_url
    bot.enable_heartbeat = this.getConfig('qq').enable_heartbeat
    bot.use_ws = this.getConfig('qq').use_ws
    bot.use_http = this.getConfig('qq').use_http
    bot.use_http = this.getConfig('qq').use_http
    bot.post_url = this.getConfig('qq').post_url
    bot.rate_limit_interval = this.getConfig('qq').rate_limit_interval
    bot.heartbeat_interval = this.getConfig('qq').heartbeat_interval
    bot.ws_reverse_reconnect_interval = this.getConfig('qq').ws_reverse_reconnect_interval
